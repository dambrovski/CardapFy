          ...
          <div class="jumbotron">
            ...
            <div class="row">
                <tr>
                    ...
                    <tr>
                        <td>
                        <a href="./Salad/CadSalada.php" class="btn btn-success">Cadastrar Salada!</a>
                        </td>
                        <td>
                            <a href="./Salad/LstSalada.php" class="btn btn-primary">Listar Saladas!</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        <a href="./Ext/CadExtra.php" class="btn btn-success">Cadastrar Extra!</a>
                        </td>
                        <td>
                            <a href="./Ext/LstExtra.php" class="btn btn-primary">Listar Extras!</a>
                        </td>
                    </tr>
            </div>
            </div>
